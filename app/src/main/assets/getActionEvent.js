async function a() {
    try {
        ...
        for (var i = 0; i < 10; i++) {
            var result;
            ajaxData = [];
            ajaxData.push({ "index": 0, "methodname": "core_calendar_get_action_events_by_timesort", "args": { "limitnum": 50, "timesortfrom": -1, "limittononsuspendedevents": false, "aftereventid": eventID } });
